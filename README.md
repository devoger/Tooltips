<main>
  ...
  <div class="example-elements">
    ...
    <p data-tooltip="A sample text. A sample text. A sample text. A sample text. A sample text">
  ...
  <div class="info-wrapper">
    ...
    <p 
      ...
      To use the tooltip, simply add the attribute »data-tooltip« with the desired text to a element. P.S. Hover over me to see a long tooltip.
    </p>
  </div>
</main>
